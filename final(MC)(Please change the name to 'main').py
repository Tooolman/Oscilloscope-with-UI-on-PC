...
# import pyb
# 
# # 创建一个Pin对象，引脚号为X1（示例中的引脚号为X1，请根据实际情况修改）
# pintest = pyb.Pin('PE14', pyb.Pin.OUT)
# # 将引脚设置为高电平
# pintest.high()
# pintest.low()
####################Swithch Control############################
s1 = pyb.Pin('PE11', pyb.Pin.OUT)
s2 = pyb.Pin('PE12', pyb.Pin.OUT)
s3 = pyb.Pin('PE13', pyb.Pin.OUT)
s4 = pyb.Pin('PE14', pyb.Pin.OUT)
s1.low()
s2.low()
s3.low()
s4.low()
